 ...
 * https://github.com/dredix84/mysql-mariadb-http-tunnel
 * Author: Andre Dixon
 ...
 */
$allow_specific_ip = true;
$use_basic_authenication = true;
$prevent_flood_attempts = false;
...
if ($allow_specific_ip) {
    if ((!in_array($_SERVER['REMOTE_ADDR'], $allowlist))) {
        header("WWW-Authenticate: Basic realm=\"Private Area\"");
        header("HTTP/1.0 401 Unauthorized");
        print "Sorry - connections are not allowed for your computer!\n";
        exit;
    }
}

if ($prevent_flood_attempts) {
